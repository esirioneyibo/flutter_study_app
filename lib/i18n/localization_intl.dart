...
import 'package:flutter_study_app/i10n/message/messages_all.dart';
...
// --------------------------------------账号相关-------------------------------------------------
  ...
  String get deviceInfo {
    return Intl.message('deviceInfo',
        name: 'deviceInfo', desc: '设备信息', locale: Intl.defaultLocale);
  }

  String get appName => Intl.message('appName',
      name: 'appName', desc: 'app name', locale: Intl.defaultLocale);

  get newChat => Intl.message('newChat',
      name: 'newChat', desc: '发布帖子', locale: Intl.defaultLocale);

  String get chatContent => Intl.message('chatContent',
      name: 'chatContent', desc: '帖子内容', locale: Intl.defaultLocale);

  String get close => Intl.message('close',
      name: 'close', desc: '关闭', locale: Intl.defaultLocale);

  String get cancel => Intl.message('cancel',
      name: 'cancel', desc: '取消', locale: Intl.defaultLocale);

  String get ok =>
      Intl.message('ok', name: 'ok', desc: '确定', locale: Intl.defaultLocale);
